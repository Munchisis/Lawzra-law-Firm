...
import logo_02 from "./img/logo02.png";
import logo_WB from "./img/logoWB.png";
import banking from "./img/banking.png";
import corporate from "./img/corporate.png";
import dispute from "./img/dispute.png";
...
import office5 from "./img/office5.png";
import profile from "./img/profile.png";
import profile1 from "./img/profile1.png";
import profile2 from "./img/profile2.png";
import profile3 from "./img/profile3.png";
import custody from "./img/custody.jpg";
import privacyPolicy from "./img/privacyPolicy.jpg";
import cookiePolicy from "./img/cookiePolicy.jpg"
import termsOfService from "./img/termsOfService.jpg"
...
export const practiceAreasCard = [
  ...
  {title: "Technology, Media & Telecommunications",image: tech, path: "tech"},
...
export const practiceAreas = [
  { title: "Banking & Finance Law", path: "banking" },
  { title: "Corporate & Commercial", path: "corporate" },
  { title: "Dispute Resolution", path: "dispute" },
  { title: "Intellectual Property", path: "ip" },
  { title: "Privacy and Data Protection", path: "privacy" },
  { title: "Real Estate", path: "real-estate" },
  { title: "Tax and Transfer Pricing", path: "tax" },
  { title: "Technology, Media & Telecommunications", path: "tech" },
  { title: "Energy Law", path: "energy" },
];
